...
video = cv2.VideoCapture('/home/labuser/ros_ws/src/odhe_ros/arm_camera_dataset2/raw_videos/test_videos/test_1a.avi')
...
cfg.MODEL.WEIGHTS = "/home/labuser/ros_ws/src/odhe_ros/arm_camera_dataset2/models/final_model/output_35k/model_0004999.pth"
# cfg.MODEL.WEIGHTS = os.path.join(cfg.OUTPUT_DIR, "model_final.pth")
cfg.MODEL.ROI_HEADS.SCORE_THRESH_TEST = 0.5   # set the testing threshold for this model
predictor = DefaultPredictor(cfg)

class_names = ["Gripper", "Beans", "Cottage Cheese", "Yogurt", "Watermelon", "Banana", \
                                                      "Strawberry", "Celery", "Carrot", "Pretzel", "Knife", "Spoon", "Fork", \
                                                      "Cup", "Bowl", "Plate"]

colors = [(178, 80, 80), (140, 120, 240), (89, 134, 179), (250, 250, 55), (131, 224, 112), \
