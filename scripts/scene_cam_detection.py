...
class maskRCNN(object):
    def __init__(self):
        ...
        # Publishers
        self.pub = rospy.Publisher('scene_camera_detections', DetectionList, queue_size=10)
...
def main():
    ...
    rospy.init_node("scene_cam_detections", anonymous=True)
    ...
    while not rospy.is_shutdown():
        ...
        if run.raf_state.enable_scene_detections:
            rospy.loginfo_once("Running scene detection inference...")
